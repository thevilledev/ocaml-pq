(** ML-KEM-512, as standardized by FIPS 203.
    ...
    ML-KEM-512 is the smallest FIPS 203 parameter set. Applications without a
    specific security-level requirement should prefer {!Mlkem768}.
...
(** The size of an encoded encapsulation key: 800 bytes. *)

val ciphertext_size : int
(** The size of a ciphertext: 768 bytes. *)
